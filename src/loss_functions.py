...
def cross_entropy(all_token_likelihoods, ground_truth_tokens, masked_batch_bool):
    # Get the probability distributions of the masked token prediction
    masked_token_distributions = all_token_likelihoods[masked_batch_bool]
...
def negative_log_likelihood(
    all_token_likelihoods, ground_truth_tokens, masked_batch_bool
):
